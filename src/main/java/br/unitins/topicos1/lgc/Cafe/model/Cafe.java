...
public class Cafe extends DefaultEntity {
    ...
    @CollectionTable(name = "cafe_notasensorial", joinColumns = @JoinColumn(name = "id_cafe"))
    @Enumerated(EnumType.STRING)
    ...
    public void setPontuacaoSCA(Integer pontuacaoSCA) { this.pontuacaoSCA = pontuacaoSCA; }
    public Marca getMarca() { return marca; }
    public void setMarca(Marca marca) { this.marca = marca; }
    public CategoriaDoCafe getCategoriaDoCafe() { return categoriaDoCafe; }
    public void setCategoriaDoCafe(CategoriaDoCafe categoriaDoCafe) { this.categoriaDoCafe = categoriaDoCafe; }
    public RegiaoDeOrigem getRegiaoDeOrigem() { return regiaoDeOrigem; }
    public void setRegiaoDeOrigem(RegiaoDeOrigem regiaoDeOrigem) { this.regiaoDeOrigem = regiaoDeOrigem; }
    public NivelDeTorra getNivelDeTorra() { return nivelDeTorra; }
    public void setNivelDeTorra(NivelDeTorra nivelDeTorra) { this.nivelDeTorra = nivelDeTorra; }
    ...
    public Set<NotaSensorial> getNotasSensoriais() { return notasSensoriais; }
    public void setNotasSensoriais(Set<NotaSensorial> notasSensoriais) { this.notasSensoriais = notasSensoriais; }
}